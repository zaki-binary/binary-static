...
function showHighchart(){
  ...
  div.innerHTML = '<table width="600px" align="center"><tr id="highchart_duration"><td align="right" width="25%">' +
                  ...
                  Content.localize().textTickResultLabel.toLowerCase() + '</option><option value="1m">1 ' + Content.localize().textDurationMinutes.toLowerCase() +
                  ...
                  '</option><option value="1h">1 ' + Content.localize().textDurationHours.toLowerCase() + '</option><option value="2h">2 ' +
                  ...
                  Content.localize().textDurationDays.toLowerCase() +'</option></select></td></td></tr><tr align="center"><td colspan="4">' +
