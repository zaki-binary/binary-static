<div class="grd-grid-12">
    ...
    <p>[% l("We recognize the importance of protecting your personal and financial information.") %]</p>
    <p>[% l("The personal information that we obtain about you assists us in servicing your account. We know you may be concerned about what we do with this information, and with financial information about your account. The following outlines our privacy practices.") %]</p>
    <h2>[% l("Use of Information") %]</h2>
    ...
    <p>[% l("The above personal data that we collect will be held by us and processed for any purpose as may be allowed by law or required by any law. We may also transfer such personal data to any company within the Regent Markets Group of companies or any of our business associates.") %]</p>
    ...
    <p>[% l("Please note that you may update your personal information at any time by logging into the \"Settings\" section of your account. It is your responsibility to ensure that [_1] is promptly and continually informed of any change in your personal information.", SITENAME) %]</p>
    <h2>[% l("Security Statement") %]</h2>
    <p>[% l("We are committed to making sure your personal data and transactions are secure:") %]</p>
    <ol>
    <li>[% l("Your password and login ID are unique and passwords are hashed so that not even [_1] staff can read them. This is the reason why we cannot retrieve your password and have to issue you with a new one to your email address if you cannot recall it.", SITENAME) %]</li>
    ...
    <h2>[% l("Notification of Changes") %]</h2>
    <p>[% l("Any changes in our privacy policy or security statement will be posted onto this website. In the event of material changes that directly affect the economic use of your personal information, we will request your prior authorisation in writing before effecting such change on your account.") %]</p>
