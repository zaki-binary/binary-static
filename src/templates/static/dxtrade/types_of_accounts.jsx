        ...
        <div className='box'>
            <div className='gr-row gr-row-align-middle'>
                <div className='gr-2 gr-3-p gr-12-m center-text gr-centered'>
                    <img className='gr-padding-10 gr-parent' src={it.url_for(`images/pages/dxtrade/icons/acc_${image}.svg`)} />
...
const TypesOfAccounts = () => (
    <div id='dxtrade_types_of_accounts' className='static_full'>
        <h1>{it.L('Types of DXTrade accounts')}</h1>
                ...
                <div className='hide-maltainvest'>
                    <Table
                        ...
                        data={{
                            ...
                            tbody: [
                                [{ text: <Row             text={it.L('Account currency')} /> },         { text: it.L('USD') },                                                  { text: it.L('USD') }],
                                [{ text: <Row number={1}  text={it.L('Leverage')} /> },                 { text: it.L('Up to [_1]', '1:100') },                                  { text: it.L('Up to [_1]', '1:1000') }],
                                ...
                                [{ text: <Row             text={it.L('Trading instruments')} /> },      { text: it.L('FX-majors, FX-minors, FX-exotics, Cryptocurrencies') },   { text: it.L('Synthetics') }],
                            ],
                        }}
