...
import Forex from './how_to_trade_dxtrade/forex.jsx';
import Metals from './how_to_trade_dxtrade/metals.jsx';
import CFDs from './how_to_trade_dxtrade/cfds.jsx';
import Cryptocurrencies from './how_to_trade_dxtrade/cryptocurrencies.jsx';
import { TabContainer, TabsSubtabs, TabContentContainer, TabContent } from '../../_common/components/tabs.jsx';

const HowToTradeDXTrade = () => (
    <div id='how_to_trade_mt5' className='static_full'>
        <h1>{it.L('How to Trade in DXTrade')}</h1>
...
export default HowToTradeDXTrade;
