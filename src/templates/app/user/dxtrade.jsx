...
const AccountDesc = ({ title, description, account_type, landing_company_short, items, id = undefined }) => {
    ...
    return (
        <div className={types} id={id}>
            ...
            <p>
                <a className='button' href={it.url_for('dxtrade/types-of-accounts')} target='_blank'>
                    <span>{it.L('Compare DXTrade accounts')}</span>
                </a>
            </p>
        </div>
    );
...
const TypeGroup = ({ title, children, types }) => (
    <div className='type-group gr-row'>
        ...
        {types.map((box, i) => (
            ...
            >
                <div id={box.id || `rbtn_${box.type}`} className='dxtrade_type_box' data-acc-type={box.type}>
                    {box.title ?
                        <div>{box.title}</div>
                        :
                        <img src={it.url_for(`images/pages/dxtrade/icons/acc_${box.desc.toLowerCase()}.svg`)} />
                    }
                </div>
...
const CashierDesc = ({ title, desc, arrow_direction }) => (
    <div className='center-text hint gr-padding-20 gr-parent'>
        ...
        <div className='vertical-center gr-padding-10'>
            <img src={it.url_for('images/pages/dxtrade/dashboard/binary_wallet.svg')} />
            <img src={it.url_for(`images/pages/dxtrade/dashboard/arrow_${arrow_direction}.svg`)} className='gr-gutter' />
            <img src={it.url_for('images/pages/dxtrade/dashboard/dxtrade_wallet.svg')} />
        </div>
    </div>
);
...
const DXTrade = () => (
    <React.Fragment>
        ...
        <div id='dxtrade_loading'><Loading /></div>
        <div id='dxtrade_account_management' className='gr-row invisible'>
            <div id='dxtrade_left_panel' className='gr-9 gr-12-t gr-12-p gr-12-m gr-no-gutter gr-gutter-right gr-no-gutter-p gr-no-gutter-m'>
                <div id='account_details' className='dxtrade-panel dxtrade-container'>
                    <div className='gr-row'>
                        <div className='gr-9 gr-12-m gr-12-p'>
                            <div className='gr-row'>
                                <div className='gr-grow'>
                                    <div id='account_selector'>
                                        <h4 id='dxtrade_account' />
                            ...
                            <div className='acc-info has-account invisible'>
                                <div className='gr-row gr-padding-10'>
                                    <div className='gr-3'>{it.L('DXTrade Login:')}</div>
                                ...
                                <div id='dxtrade-trade-server-container' className='gr-row gr-padding-10 gr-parent invisible'>
                                    <div className='gr-3'>{it.L('Trade server:')}</div>
                                    <div className='dxtrade-trade-server' data='trade_server' />
                                </div>
                            </div>
                        </div>
                ...
                <div className='dxtrade-panel'>
                    <div className='acc-actions'>
                        <a href='javascript:;' className='act_new_account new-account center-text invisible'>
                            <span>{it.L('Create DXTrade account')}</span>
                        </a>
                        ...
                        <a href='javascript:;' className='act_manage_password has-account center-text invisible'>
                            <span>{it.L('Manage DXTrade password')}</span>
                        </a>
                    </div>
                    <div className='fst-container dxtrade-container'>
            ...
            <div id='dxtrade_right_panel' className='gr-3 gr-12-t gr-12-p gr-12-m gr-no-gutter gr-gutter-left gr-no-gutter-p gr-no-gutter-m'>
                ...
                <div className='dxtrade-panel'>
                    <div className='dxtrade-sidebar-button border-bottom'>
                        <div className='small-icon'>
                            <a href={it.url_for('dxtrade/download')}>
                                <img src={it.url_for('images/pages/dxtrade/dashboard/dxtrade.png')} />
                            </a>
                        </div>
                        <div className='dxtrade-link-download'>
                            <a href={it.url_for('dxtrade/download')} className='dxtrade-link-button'>
                                {it.L('Go to DXTrade download page')}
                            </a>
                        </div>
                    </div>
                </div>
                <div className='dxtrade-panel'>
                    <div className='dxtrade-sidebar-button dxtrade-web'>
                        <div className='small-icon'>
                            <a href='https://trade.mql5.com/trade?servers=Deriv-Server&trade_server=Deriv-Server' target='_blank' rel='noopener noreferrer'>
                                <img src={it.url_for('images/pages/dxtrade/dashboard/img-app-mac@2x.png')} />
                            </a>
                        </div>
                        <div className='dxtrade-title-dxtrade-web'>
                            {it.L('DXTrade Web platform')}
                        </div>
                        <div className='dxtrade-link-web'>
                            <div className='dxtrade-web-link'>
            ...
            <div id='templates' className='invisible'>
                <div className='acc-name invisible'>
                    <div className='dxtrade-icon'>
                        <img src={it.url_for('images/pages/dxtrade/dashboard/account.svg')} />
                    </div>
                    <div className='-balance invisible'>&nbsp;</div>
                    <span className='dxtrade-type' />
                    <span className='dxtrade-login' />
                    <span className='dxtrade-server dxtrade-trade-server' />
                </div>
                <div className='account-desc'>
                    ...
                    <AccountDesc
                        ...
                        description={it.L('Our DXTrade Financial account is suitable for both new and experienced traders.')}
                        items={[
                        ...
                        <div id='mv_new_account'>
                            <div id='view_1' className='center-text'>
                                ...
                                <div className='step-2 invisible'>
                                    ...
                                    >
                                        <a className='hint hl-types-of-accounts' href={it.url_for('dxtrade/types-of-accounts')} target='_blank'>{it.L('Which account is right for me?')}</a>
                                    </TypeGroup>
                                </div>
                ...
                <div id='frm_manage_password'>
                    <div className='gr-row'>
                        <div className='gr-6 gr-12-m flex'>
                            <div className='dxtrade-panel dxtrade-container'>
                                <form id='frm_password_change'>
                                    ...
                                    <FormRow
                                        ...
                                        default_option='main'
                                    />
                                    <FormRow is_two_rows type='password' id='txt_old_password' label={it.L('Current DXTrade password')} />
                                    <FormRow is_two_rows type='password' id='txt_new_password' label={it.L('New DXTrade password')} hint={it.L('Minimum of eight lower and uppercase English letters with numbers')} />
                                    <FormRow is_two_rows type='password' id='txt_re_new_password' label={it.L('Verify new DXTrade password')} />
                                    <SubmitButton
                                        no_wrapper
                                        type='submit'
                                        id='btn_submit_password_change'
                                        text={it.L('Change DXTrade password')}
                            ...
                            <div className='dxtrade-panel dxtrade-container'>
                                ...
                                <form className='invisible' id='frm_verify_password_reset'>
                                    <div className='gr-padding-10'>
                                        ...
                                        <SubmitButton
                                            ...
                                            text={it.L('Reset DXTrade password')}
                                ...
                                <form className='invisible' id='frm_password_reset'>
                                    <FormRow
                                        ...
                                        default_option='main'
                                    />
                                    <FormRow is_two_rows type='password' id='txt_reset_new_password' label={it.L('New DXTrade password')} hint={it.L('Minimum of eight lower and uppercase English letters with numbers')} />
                                    <FormRow is_two_rows type='password' id='txt_reset_re_new_password' label={it.L('Verify new DXTrade password')} />
                                    <SubmitButton
                                        no_wrapper
                                        type='submit'
                ...
                <div id='frm_cashier'>
                    ...
                    <div className='real-only invisible'>
                        <div className='gr-padding-20 gr-parent'>
                            <div className='fill-bg-color center-text dxtrade-container'>
                                <div className='gr-10 gr-push-1 gr-12-m gr-push-0-m'>
                                    <h3 className='secondary-color'>{it.L('How to manage your funds')}</h3>
                                    <p className='hint'>{it.L('Deposits and withdrawals for your DXTrade account always pass through your binary options account.')}</p>
                                    <div className='gr-row'>
                                        ...
                                        <div className='gr-2 gr-padding-20 gr-no-gutter-m'>
                                            <img src={it.url_for('images/pages/dxtrade/dashboard/transfer.svg')} />
                                        </div>
                                        <div className='gr-5 gr-no-gutter-m gr-gutter-left-m'>
                                            <img src={it.url_for('images/pages/dxtrade/dashboard/dxtrade_wallet.svg')} />
                                            <div className='dxtrade-account gr-padding-10' />
                                            <div className='dxtrade-balance gr-padding-10 gr-parent' />
                        ...
                        <div className='gr-padding-20 gr-parent no-margin hint center-text invisible' id='dxtrade_remaining_transfers'>
                            {it.L('Remaining DXTrade fund transfers for today: [_1]', '<strong />')}
                        </div>
                        <div className='gr-row'>
                            <div className='gr-6 gr-12-m flex'>
                                <div className='dxtrade-panel dxtrade-container'>
                                    <form id='frm_deposit'>
                                        <CashierDesc title={it.L('Transfer funds to your DXTrade account')} arrow_direction='right' desc={it.L('Transfer funds from your binary options account into your DXTrade account.')} />
                            ...
                            <div className='gr-6 gr-12-m flex'>
                                <div className='dxtrade-panel dxtrade-container'>
                                    <form id='frm_withdrawal'>
                                        <CashierDesc title={it.L('Withdraw funds from your DXTrade account')} arrow_direction='left' desc={it.L('Transfer funds from your DXTrade account into your binary options account.')} />
                                        ...
                                        <div className='form'>
                                            ...
                                            <SubmitButton
                                                ...
                                                text={it.L('Withdraw from DXTrade')}
                ...
                <div id='messages'>
                    ...
                    <div id='msg_real_financial'>
                        <span id='msg_dxtrade_account' className='invisible'>{it.L('To create a DXTrade account:')}</span>
                        <ul className='bullet'>
                            ...
                            <li className='trading_experience invisible'>{it.L('Please [_1]complete the trading experience section[_2] in the financial assessment to open an DXTrade account.', `<a href="${it.url_for('user/settings/assessmentws')}">`, '</a>')}</li>
                            <li className='assessment invisible'>{it.L('Please [_1]complete the financial assessment[_2] to open an DXTrade account.', `<a href="${it.url_for('user/settings/assessmentws')}">`, '</a>')}</li>
                            ...
                            <li className='authenticate invisible'>{it.L('Please [_1]authenticate your account[_2] before creating an DXTrade account.', `<a href="${it.url_for('user/authenticate')}">`, '</a>')}</li>
                        </ul>
                    </div>
                    <div id='msg_authenticate'>{it.L('To withdraw from DXTrade Financial Account please [_1]Authenticate[_2] your Binary account.', `<a href="${it.url_for('user/authenticate')}">`, '</a>')}</div>
                </div>
            </div>
        </div>
    </React.Fragment>
