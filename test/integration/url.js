module.exports = {
    ...
    BINARY_OPTIONS_BASICS: '/get-started/binary-options-basics',
    BENEFITS_OF_BINARY_TRADING: '/get-started/benefits-of-trading-binaries',
    HOW_TO_TRADE_BINARIES: '/get-started/how-to-trade-binaries',
    HOW_TO_TRADE_THE_RANDOM_MARKETS: '/get-started/random-markets',
    ...
    RESPONSIBLE_TRADING: '/responsible-trading',
    TERMS_AND_CONDITIONS: '/c/c_template.cgi?filecode=legal',

    SECURITY_AND_PRIVACY: '/c/c_template.cgi?filecode=legal',

    GETTING_STARTED: '/get-started',
    PLATFORM_TOUR: '/tour',

    CHART_APPLICATION: '/c/chart_application.cgi',

    GROUP_INFORMATION: '/about-us',
